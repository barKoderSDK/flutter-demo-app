...
class MultiSettingsPage extends StatefulWidget {
  final List<BarcodeType> selectedBarcodeTypes;

  const MultiSettingsPage({super.key, required this.selectedBarcodeTypes});

  @override
  MultiSettingsPageState createState() => MultiSettingsPageState();
}

class MultiSettingsPageState extends State<MultiSettingsPage> {
  ...
  Future<void> _loadSettings() async {
    selectedBarcodeTypes = await _baseSettings.loadBarcodeTypes('selectedMultiScanBarcodeTypes', getMultiScan());
    _allowPinchToZoom = await _baseSettings.loadAllowPinchToZoomSetting('allowPinchToZoomMultiScan');
    _allowBeep = await _baseSettings.loadBeepSetting('allowBeepMultiScan');
    _allowVibrate = await _baseSettings.loadVibrateSetting('allowVibrateMultiScan');
    _decodingSpeed = await _baseSettings.loadDecodingSpeedSetting('decodingSpeedMultiScan');
    _resolution = await _baseSettings.loadResolutionSetting('resolutionMultiScan');
    _formating = await _baseSettings.loadFormatingSetting('formatingMultiScan');
    _charset = await _baseSettings.loadCharsetSetting('charsetMultiScan');
    _allowContinuousScanning = await _baseSettings.loadAllowContinuousScanning('continuousScanningMultiScan');
    _allowMisshaped = await _baseSettings.loadAllowMisshaped('misshapedMultiScan');
  ...
  void _saveSettings() {
    _baseSettings.saveBarcodeTypes('selectedMultiScanBarcodeTypes', selectedBarcodeTypes);
    _baseSettings.saveAllowPinchToZoomSetting('allowPinchToZoomMultiScan', _allowPinchToZoom);
    _baseSettings.saveBeepSetting('allowBeepMultiScan', _allowBeep);
    _baseSettings.saveVibrateSetting('allowVibrateMultiScan', _allowVibrate);
    _baseSettings.saveDecodingSpeedSetting('decodingSpeedMultiScan', _decodingSpeed);
    _baseSettings.saveResolutionSetting('resolutionMultiScan', _resolution);
    _baseSettings.saveFormatingSetting('formatingMultiScan', _formating);
    _baseSettings.saveCharsetSetting('charsetMultiScan', _charset);
    _baseSettings.saveAllowContinuousScanning('continuousScanningMultiScan', _allowContinuousScanning);
    _baseSettings.saveAllowMisshaped('misshapedMultiScan', _allowMisshaped);
  ...
  void _resetSettings() {
    setState(() {
      selectedBarcodeTypes = getMultiScan();
  ...
  void _togglePinchToZoom(bool value) {
    ...
    _baseSettings.saveAllowPinchToZoomSetting('allowPinchToZoomMultiScan', value);
  }
  ...
  void _toggleBeep(bool value) {
    ...
    _baseSettings.saveBeepSetting('allowBeepMultiScan', value);
  }
  ...
  void _toggleVibrate(bool value) {
    ...
    _baseSettings.saveVibrateSetting('allowVibrateMultiScan', value);
  }
  ...
  void _toggleDecodingSpeed(DecodingSpeed speed) {
    ...
    _baseSettings.saveDecodingSpeedSetting('decodingSpeedMultiScan', speed);
  }
  ...
  void _toggleResolution(BarkoderResolution resolution) {
    ...
    _baseSettings.saveResolutionSetting('resolutionMultiScan', resolution);
  }
  ...
  void _toggleFormating(FormattingType formating) {
    ...
    _baseSettings.saveFormatingSetting('formatingMultiScan', formating);
  }
  ...
  void _toggleCharset(String charset) {
    ...
    _baseSettings.saveCharsetSetting('charsetMultiScan', charset);
  }
  ...
  void _toggleShowBottomsheet(bool value) {
    ...
    _baseSettings.saveShowBottomsheet('bottomsheetMultiScan', value);
  }
  ...
  void _toggleMisshaped(bool value) {
    ...
    _baseSettings.saveAllowMisshaped('misshapedMultiScan', value);
  }
  ...
  void _toggleBlurredUPC(bool value) {
    ...
    _baseSettings.saveAllowBlurredUPC('blurredUPCMultiScan', value);
  }
